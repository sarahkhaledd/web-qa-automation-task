...
const { user, newUser } = require('../testData/credentials');
  describe('POST /api/v1/users - Register', () => {
    ...
    it.skip('REG01 - should return 200 with success message and token for valid registration', async () => {
    ...
    it.skip('REG03 - should return 401 when email field is empty during registration - KNOWN BUG: Empty email validation not working', async () => {
    ...
    it.skip('REG04 - should return 401 when password field is empty during registration - KNOWN BUG: Empty password validation not working', async () => {
    ...
    it.skip('REG05 - should return 401 when registration request body contains null values - KNOWN BUG: Null validation not working', async () => {
    ...
    it.skip('REG06 - should return 401 when registration request body contains empty strings - KNOWN BUG: Empty string validation not working', async () => {
    ...
    it.skip('REG07 - should return 401 when email format is invalid during registration - KNOWN BUG: Invalid email format validation not working', async () => {
  ...
  describe('Authentication API Tests', () => {
    ...
    describe('POST /api/v1/auth - Login', () => {
      ...
      it.skip('LOG07 - should return 401 when login request body contains null values - KNOWN BUG: Null login validation not working', async () => {
